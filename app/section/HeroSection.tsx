    ...
    <section className="overflow-hidden">
      <div className="px-6 md:max-w-screen-md md:px-6 lg:max-w-screen-xl mx-auto py-24 h-screen md:flex items-center">
        <div className="mx-auto w-full md:w-7/12 z-20 flex flex-col gap-y-4 items-center md:items-start">
          ...
          <p className="leading-relaxed mt-6 w-11/12 lg:w-8/12 text-center md:text-left text-md md:text-lg dark:text-slate-300">
        ...
        <div className="w-full md:w-5/12 feature-image-box mt-5 relative">
          <div className="globe opacity-30 lg:opacity-50">
            <div className="globe-item globe-item__primary rounded-full absolute z-10 md:w-[200px] lg:w-[400px] md:h-[200px] lg:h-[400px] bg-gradient-to-tr from-blue-400 to-blue-600"></div>
            <div className="globe-item globe-item__warning rounded-full absolute z-10 md:w-48 md:h-48 lg:w-96 lg:h-96 bg-gradient-to-tr from-yellow-500 to-yellow-300"></div>
            <div className="globe-item globe-item__success rounded-full absolute z-10 md:w-48 md:h-48 lg:w-96 lg:h-96 bg-gradient-to-tr from-green-500 to-green-300"></div>
            <div className="globe-item globe-item__danger rounded-full absolute z-10 md:w-[150px] md:h-[150px] lg:w-[300px] lg:h-[300px] bg-gradient-to-tr from-red-300 to-red-500"></div>
          </div>
